...
<body class="p-2">
    <div class="flex justify-between">
        <a href="tambah.php" class="font-bold text-green-500 hover:underline hover:text-green-500">Tambah Data</a><br>
    ...
    <div class="overflow-auto rounded-lg shadow">
        ...
        ?>
                <tr class="bg-gray-50">
                    ...
                    <td class="p-3 text-sm text-gray-700 whitespace-nowrap"><?= $siswa['id_kelas'] ?></td>
