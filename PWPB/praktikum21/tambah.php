<?php
    ...
    flash("alert", "success", "Tambah data siswa berhasil");
        ...
        $mysqli -> query("INSERT INTO siswa (nis, nama, jenis_kelamin, jurusan, alamat, gol_darah, nama_ibu, file, id_kelas ) VALUES ($nis, '$nama', '$jenis_kelamin', '$jurusan', '$alamat', '$gol_darah', '$nama_ibu', '$file_destination', '$idKelas' )") or die ($mysqli -> error);
